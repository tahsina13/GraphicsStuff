...
void draw_scanline( int y, int x0, double z0, int x1, double z1, 
                    screen s, zbuffer zb, color c )
{
    int xt;
    double zt;
...
void scanline_convert( struct matrix *points, int i, screen s, zbuffer zb )
{
    ...
    dy1 = points->m[1][top] - points->m[1][mid];
